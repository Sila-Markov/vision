...
namespace GVMP
{
    class BarberModule : GVMP.Module.Module<BarberModule>
    {
        ...
        public void openBarberShop(Client c)
        {
            try
            {
                if (c == null) return;
        ...
        public void barberShopBuy(Client c, int price, string json)
        {
            try
            {
                if (c == null) return;
        ...
        public void barberShopExit(Client client)
        {
            try
            {
