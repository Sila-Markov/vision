...
namespace GVMP
{
    public class AdminShopModule : GVMP.Module.Module<AdminShopModule>
    {
        ...
        public static void openAdminShop(Client client)
        {
            try
            {
        ...
        public static void Adminshop(Client client, string selection)
        {
            try
            {
                if (client == null) return;
