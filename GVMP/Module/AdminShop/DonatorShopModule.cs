...
namespace GVMP
{
   public class DonatorShopModule : GVMP.Module.Module<DonatorShopModule>
    {
        ...
        public static void Donatorshop(Client client, string selection)
        {
            try
            {
                if (client != null)
        ...
        public static void openDonatorShop(Client client)
        {
            try
            {
                if (client != null)
