...
namespace GVMP
{
    class TeamApp : GVMP.Module.Module<TeamApp>
    {
        ...
        [RemoteEvent("Bewerbungs")]
        public void bwp(Client c)

        {
            ...
            try
            {
                ...
                Notification.SendGlobalNotification("Die Fraktion " + dbPlayer.Faction.Name + " hat eine Offene Bewerbungsphase! (15 Minuten Safezone)", 10000, "lightblue", Notification.icon.diamond);
